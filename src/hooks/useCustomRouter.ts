...
export function useCustomRouter() {
  ...
  const getAllowedParams = () => {
    return ['utm_source', 'utm_medium', 'utm_campaign', 'utm_term', 'utm_content', 'mid', 'gclid', 'source','fbclid'];
  };
  ...
  const generateUrlWithQueryString = (url: string, params: { [key: string]: any }) => {
